  ...
  return (
    <group>
      ...
      <group>
        ...
        {/* walls — front (partial, leave entrance) */}
        <mesh
          position={[-12, WALL_HEIGHT / 2, HD]}
          castShadow
          receiveShadow
          material={mats.wall}
        >
        ...
        <mesh position={[0, 0.3, -HD + 0.16]} material={mats.wallAccent}>
          <boxGeometry args={[FLOOR_WIDTH, 0.15, 0.02]} />
        </mesh>

        {/* open workspace (left side) */}
      ...
      {/* ═══ FLOOR 2 ═══ */}
      <group position={[0, WALL_HEIGHT + 0.15, 0]}>
        {/* floor surface */}
        ...
        {/* private offices (left) — 3 glass-walled offices */}
        {[0, 1, 2].map((i) => (
